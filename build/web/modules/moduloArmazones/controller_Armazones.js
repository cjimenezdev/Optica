...
export function loadTabla(){
    ...
    armazones.forEach(function (armazon){
        let registro =  
                '<tr onclick="moduloArmazon.selectArmazon('+ armazones.indexOf(armazon) +');">'+
                '<td>' + armazon.nombre + '</td>' +
                '<td>' + armazon.marca + '</td>' + 
                '<td>'+ armazon.modelo +'</td>' +
                '<td>' + armazon.color + '</td>' +
                '<td>' + armazon.descripcion + '</td>' +
                '<td>' + armazon.fotografía + '</td>' +
...
export function selectArmazon(index){
    document.getElementById("txtNumUnico").value = armazones[index].numero_unico_armazon;
    ...
    document.getElementById("txtCodigoBarras").value = armazones[index].codigo_barras;
...
export function searchArmazon(){
    ...
    let resultados = armazones.filter(element => element.codigo_barras === filtro);
    let cuerpo = "";
