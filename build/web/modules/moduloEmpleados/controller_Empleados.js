...
export function updateEmpleado() {
  ...
  empleado.rfc = rfc;
  empleado.genero = genero;
  empleado.clave = clave.toUpperCase();
  empleado.usuario = usuario;
  empleado.contrasena = contrasena;
  empleado.estatus = "Activo";
...
export function deleteEmpleado() {
  empleados[indexEmpleadoSeleccionado].nombre;
  Swal.fire({
    title: "Eliminar: ",
    text: empleados[indexEmpleadoSeleccionado].nombre,
    icon: "question",
    showConfirmButton: true,
    showCancelButton: true,
    confirmButtonText: "Aceptar",
    ...
    if (result.isConfirmed) {
      ...
      Swal.fire({
        title: `Empleado ` + empleados[indexEmpleadoSeleccionado].estatus,
        icon: "success",
        showConfirmButton: false,
        timer: 1400,
        showClass: {
...
export function searchEmpleado() {
  ...
  if (filtro == "") {
    document.getElementById("txtBusquedaEmpleado").classList.add("input-email");
    document.getElementById("txtBusquedaEmpleado").focus();
    let placeholder = document.getElementById(
      "txtBusquedaEmpleado"
    ).placeholder;
    document.getElementById("txtBusquedaEmpleado").placeholder =
      "Código Empleado";
  } else {
